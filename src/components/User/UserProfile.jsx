      ...
      {editData ? (
        <div className={styles.profileContainer}>
          ...
          <div className={styles.infoDescription}>
            <div className={styles.name}>{editData.name}</div>
            <div className={styles.account}>@{editData.account}</div>
            <div className={styles.description}>{editData.introduction}</div>
